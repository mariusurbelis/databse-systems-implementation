        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div style="background: #5D5C61; height: 100vh;" class="col-2 text-center sidebar">
                    ...
                    <a href=""><p class="nav-item"><b>Branch Info</b></p></a>
                    <a href="executive-manager-supplier-info.php"><p class="nav-item">Supplier Info</p></a>
                ...
                <div class="col-10 content">
                     <div class="row">
                        ...
                        <div style="margin-top: 1em; font-size: 2.6em;" class="col-3 offset-2">Branch Info</div>
                    </div>

                    <div style="margin-top: 3em;" class="row">

                        <div class="dev col-1 offset-2">Branch ID</div>
                        <div class="dev col-2">Address</div>
